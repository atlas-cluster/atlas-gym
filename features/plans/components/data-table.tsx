                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="start">
                    ...
                    <DropdownMenuItem
                      onClick={() => {
                        table.setSorting(
                          sorting[0]?.id === 'minDurationMonths' &&
                            sorting[0]?.desc === false
                            ? [{ id: 'minDurationMonths', desc: true }]
                            : [{ id: 'minDurationMonths', desc: false }]
                        )
                      }}>
                      Min. Duration{' '}
                      {sorting[0]?.id === 'minDurationMonths' &&
                    ...
                    <DropdownMenuItem
                      onClick={() => {
                        table.setSorting(
                          sorting[0]?.id === 'subscriptionCount' &&
                            sorting[0]?.desc === false
                            ? [{ id: 'subscriptionCount', desc: true }]
                            : [{ id: 'subscriptionCount', desc: false }]
                        )
                      }}>
                      Subscriptions{' '}
                      {sorting[0]?.id === 'subscriptionCount' &&
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem
                  onClick={() => {
                    table.setSorting(
                      sorting[0]?.id === 'price' && sorting[0]?.desc === false
                        ? [{ id: 'price', desc: true }]
                        : [{ id: 'price', desc: false }]
                    )
                  }}>
